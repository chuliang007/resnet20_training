...
void FracNet_hw(float image_hw[3][32][32]) {
	...
	for (int c_out = 0; c_out < out_channels_after_pack_hw; c_out ++) {
		generic_avgpool_hw(
			msb_fmap_tile_buffer_0_hw[c_out], pool_out_buf_hw, ctrl_avgpool_hw, c_out, pool_out_buf_copy_hw
		);
	}
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	for (int c_out = 0; c_out < out_channels_after_pack_hw; c_out ++) {
		generic_avgpool_hw(
			msb_fmap_tile_buffer_1_hw[c_out], pool_out_buf_hw, ctrl_avgpool_hw, c_out, pool_out_buf_copy_hw
		);
	}
